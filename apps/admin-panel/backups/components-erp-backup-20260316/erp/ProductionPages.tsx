...
import { ErpBadge, ErpButton, ErpCard, Row, STitle, FormRow, ErpSelect, ErpInput, Table, TableBody, TableHeader, TableRow, ErpTableHeader, ErpTableCell } from "@/components/erp/ui";
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <ErpBadge colorClass="erp-green" label={station} />
        </div>
      </div>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <ErpCard>
          ...
          <ErpButton colorClass="erp-red" className="w-full">確認報工入庫 →</ErpButton>
        </ErpCard>
        <ErpCard>
          <STitle>近期報工記錄</STitle>
          <div className="overflow-x-auto">
            <Table>
              <TableHeader><TableRow><ErpTableHeader>工單</ErpTableHeader><ErpTableHeader>成品</ErpTableHeader><ErpTableHeader>產出</ErpTableHeader><ErpTableHeader>批號</ErpTableHeader><ErpTableHeader>效期</ErpTableHeader></TableRow></TableHeader>
              <TableBody>
                {[
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <ErpBadge colorClass="erp-green" label="系統已連線" />
      </div>
